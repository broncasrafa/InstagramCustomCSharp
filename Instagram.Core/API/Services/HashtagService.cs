...
namespace Instagram.Core.API.Services
{
    public class HashtagService : IHashtagService
    {
        ...
        public IResult<Hashtag> GetHashtag(string hashtag)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.EXPLORE_TAG_DATA_INIT, hashtag);
        ...
        public IResult<EdgeHashtagToMedia> GetHashtagMedias(string hashtag, string endCursor, int limitPerPage = 12)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.EXPLORE_TAG_DATA, hashtag, limitPerPage, endCursor);
        ...
        public IResult<ShortcodeHashtagMedia> GetShortcodeHashtagMedia(string shortcode)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.EXPLORE_TAG_SHORTCODE_DATA, shortcode);
