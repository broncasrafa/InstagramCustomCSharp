...
namespace Instagram.Core.API.Services
{
    public class UserService : IUserService
    {
        ...
        public IResult<EdgeOwnerToTimelineMediaNode> GetShortcodeMedia(string shortcode)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.SHORTCODE_URL, shortcode);
        ...
        public IResult<User> GetUser(string username)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.USER_DATA_URL, username);
        ...
        public IResult<FeedReelsTray> GetRecentsFollowingUsersStories()
        {
            try
            {
                var uri = InstagramCustomApiConstants.RECENTS_FOLLOWING_USERS_STORIES;
        ...
        public IResult<DataStoryMedia> GetRecentsStoriesByUserId(string userId)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.RECENTS_STORIES_BY_USER_ID, userId);
        ...
        public IResult<DataStoryMedia> GetFeaturedStoriesByUserId(string userId)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.DESTAQUES_STORIES_BY_USER_ID, userId);
        ...
        public IResult<DataStoryMedia> GetSuggestedUsers(string userId)
        {
            try
            {
                var uri = string.Format(InstagramCustomApiConstants.SUGGESTED_USERS, userId);
